...
def generate_quantities_report_pdf(project_id=None, sub_job_id=None):
    ...
    # Get PDF data - FIX: Return bytes directly without additional encoding
    pdf_data = pdf.output(dest='S')
    
    # If pdf_data is already bytes, return it directly
    ...
    # For any other type, convert to string first then encode
    return str(pdf_data).encode('latin1')
