...
def edit_cost_code(cost_code_id):
    try:
        ...
        logger.error(f"Error editing cost code: {str(e)}")
...
def delete_rule_of_credit(rule_id):
    try:
        ...
        logger.error(f"Error deleting rule of credit: {str(e)}")
