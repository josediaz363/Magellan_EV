...
from models import db, Project, SubJob, CostCode, RuleOfCredit, WorkItem, ProjectCostCode
import uuid
import traceback
import json
...
# Constants
DISCIPLINE_CHOICES = ['Civil', 'Structural', 'Architectural', 'Mechanical', 'Electrical', 'Plumbing', 'Fire Protection', 'Controls', 'Steel']
