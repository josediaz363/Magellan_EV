...
class RuleOfCreditService(BaseService):
    ...
    # Add the missing method that's being called in routes.py
    def get_steps_for_rule(self, rule_id):
        """Get steps for a rule of credit - alias for get_steps for backward compatibility"""
        return self.get_steps(rule_id)
