...
class ProjectService:
    ...
    @staticmethod
    def create_project(name, project_id_str=None, description=""):
        """
        ...
        try:
            ...
            existing = Project.query.filter_by(project_id_str=project_id_str).first()
            if existing:
                # Append a unique identifier to make it unique
                unique_suffix = str(uuid.uuid4())[:8]
                project_id_str = f"{project_id_str}-{unique_suffix}"
    ...
    @staticmethod
    def update_project(project_id, name, project_id_str=None, description=None):
        """
        ...
        Args:
            ...
            project_id_str (str, optional): New project ID string
        ...
        if project:
            project.name = name
            if project_id_str:
                project.project_id_str = project_id_str
