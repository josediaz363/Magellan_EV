...
- Adds get_sub_jobs_by_project method for project listing
"""
...
class SubJobService:
    ...
    @staticmethod
    def get_sub_jobs_by_project(project_id):
        """
        Get all sub jobs for a project (alias for get_project_sub_jobs)
    ...
    @staticmethod
    def create_sub_job(project_id, name, area, description, sub_job_id_str=None, budgeted_hours=0.0):
        """
        ...
        Args:
            ...
            sub_job_id_str (str, optional): Custom sub job ID string
            budgeted_hours (float, optional): Budgeted hours for the sub job
            
        Returns:
            SubJob: Newly created sub job
        """
        # Generate a sub_job_id_str based on project and name if not provided
    ...
    @staticmethod
    def update_sub_job(sub_job_id, name, area, description, budgeted_hours=None):
        """
